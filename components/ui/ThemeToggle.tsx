...
export default function ThemeToggle({ className = "" }: { className?: string }) {
  ...
  return (
    <button
      ...
      aria-label={resolvedTheme === "dark" ? "Mode Gelap Aktif (Klik untuk beralih ke Mode Terang)" : "Mode Terang Aktif (Klik untuk beralih ke Mode Gelap)"}
      title={resolvedTheme === "dark" ? "Mode Gelap Aktif — Beralih ke Mode Terang" : "Mode Terang Aktif — Beralih ke Mode Gelap"}
      id="theme-toggle-btn"
    >
