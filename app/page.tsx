...
export default function BerandaPage() {
  ...
  return (
    <>
      ...
      <section className="section-py bg-white overflow-hidden" aria-label="Pratinjau Fasilitas">
        <div className="container-custom">
          <SectionTitle
      ...
      <section className="section-py bg-gray-50 overflow-hidden" aria-label="Kegiatan Terbaru">
        <div className="container-custom">
          <SectionTitle
            label="Kabar Sekolah"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {beritaTerbaru.map((post) => (
              <TiltCard key={post.slug} glowColor="rgba(204, 31, 42, 0.2)" className="rounded-2xl h-full">
                <article className="card flex flex-col h-full rounded-2xl overflow-hidden bg-white">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {dataTestimoni.map((item) => (
              <TiltCard key={item.id} glowColor="rgba(245, 200, 0, 0.2)" className="rounded-2xl h-full">
                <div className="bg-gray-50 p-6 rounded-2xl border border-gray-100 flex flex-col justify-between h-full hover:shadow-sm transition-shadow">
                  <div>
      ...
      <section className="section-py relative overflow-hidden bg-gradient-to-br from-[var(--color-accent-tint)] via-white to-[var(--color-secondary-tint)]" aria-label="Daftarkan Anak">
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-4 pt-4">
            ...
            <MagneticButton>
              <a
                ...
                className="flex items-center gap-2 font-bold text-sm text-[var(--color-secondary)] hover:underline px-4 py-2"
              >
